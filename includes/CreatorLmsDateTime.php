...
/**
 * Class CreatorLmsDateTime
 *
 * A custom DateTime class for the Creator LMS plugin that handles UTC offsets and localizes dates.
 *
 * @package CreatorLms
...
class CreatorLmsDateTime extends DateTime {
